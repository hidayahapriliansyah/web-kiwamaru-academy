...
export default function ProgramSection() {
  const alur = [
    ...
    {
      step: "3",
      title: "Belajar Bahasa Jepang dan SSW",
      desc: "Belajar intensif selama 3–4 bulan (level N5–N4) dibimbing sensei berpengalaman.",
    },
    {
      step: "4",
      title: "Ujian JFT & SSW",
      desc: "Mengikuti ujian JFT dan SSW sebagai syarat visa TG",
    },
    {
      step: "5",
      title: "Mensetsu Job TG",
      desc: "Mengikuti interview job TG Jepang yang difasilitasi lembaga.",
    },
    {
      step: "6",
